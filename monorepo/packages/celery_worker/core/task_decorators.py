...
def _handle_chain_execution(
    session, chain_id: str, is_pipeline: bool, task_name: str, chain_execution_crud
) -> Optional[int]:
...
def _update_chain_progress(
    session, chain_execution_id: int, success: bool, chain_execution_crud
):
...
def task_logger(auto_chain: bool = False, is_pipeline: bool = False):
    ...
    def decorator(func: Callable[P, T]) -> Callable[P, T]:
        ...
        def wrapper(self: Any, *args: Any, **kwargs: Any) -> Any:
            # Import CRUD modules dynamically to avoid circular imports
            from shared.repository.crud import (
                    ...
                    try:
                        ...
                        if chain_execution_id and is_pipeline:
                            _update_chain_progress(
                                ...
                                chain_execution_id,
                                success=True,
                                chain_execution_crud=chain_execution_crud,
                            )
