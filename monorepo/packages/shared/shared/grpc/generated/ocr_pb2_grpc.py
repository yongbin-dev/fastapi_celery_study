...
class OCRService(object):
    ...
    def ExtractText(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ocr.OCRService/ExtractText',
    ...
    def ExtractTextBatch(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/ocr.OCRService/ExtractTextBatch',
    ...
    def CheckHealth(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ocr.OCRService/CheckHealth',
