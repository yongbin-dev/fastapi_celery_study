...
def upgrade() -> None:
    ...
    op.drop_index(
        op.f("idx_execution_status_created"), table_name="task_execution_history"
    )
    op.drop_index(
        op.f("idx_execution_task_attempt"), table_name="task_execution_history"
    )
    op.drop_index(
        op.f("ix_task_execution_history_attempt_number"),
        table_name="task_execution_history",
    )
    op.drop_index(
        op.f("ix_task_execution_history_task_id"), table_name="task_execution_history"
    )
    ...
    op.create_index(
        "idx_task_logs_chain_execution",
        "task_logs",
        ["chain_execution_id", "status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_task_logs_chain_execution_id"),
        "task_logs",
        ["chain_execution_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["task_id"],
            ["task_logs.task_id"],
            name=op.f("task_metadata_task_id_fkey"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("task_metadata_pkey")),
    )
    op.create_index(
        op.f("ix_task_metadata_worker_name"),
        "task_metadata",
        ["worker_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_task_metadata_task_id"), "task_metadata", ["task_id"], unique=False
    )
    op.create_index(
        op.f("idx_metadata_worker_queue"),
        "task_metadata",
        ["worker_name", "queue_name"],
        unique=False,
    )
    op.create_index(
        op.f("idx_metadata_parent_root"),
        "task_metadata",
        ["parent_id", "root_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["depends_on_task_id"],
            ["task_logs.task_id"],
            name=op.f("task_dependencies_depends_on_task_id_fkey"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["task_id"],
            ["task_logs.task_id"],
            name=op.f("task_dependencies_task_id_fkey"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["task_id"],
            ["task_logs.task_id"],
            name=op.f("task_results_task_id_fkey"),
            ondelete="CASCADE",
        ),
    ...
    op.create_index(
        op.f("idx_task_results_type"), "task_results", ["result_type"], unique=False
    )
    op.create_index(
        op.f("idx_task_results_size"), "task_results", ["result_size"], unique=False
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["task_id"],
            ["task_logs.task_id"],
            name=op.f("task_execution_history_task_id_fkey"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("task_execution_history_pkey")),
    )
    op.create_index(
        op.f("ix_task_execution_history_task_id"),
        "task_execution_history",
        ["task_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("idx_execution_task_attempt"),
        "task_execution_history",
