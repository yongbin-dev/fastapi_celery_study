...
def pipeline_stage(stage_name: str, stage_num: int):
    ...
    def decorator(func: Callable):
        ...
        def wrapper(self, *args, **kwargs):
            ...
            logger.info(f"Chain {chain_id}: Stage {stage_num} ({stage_name}) 시작 - 입력 데이터 크기: {input_size} bytes")
            ...
            try:
                ...
                status_manager.update_status(
                    chain_id, stage_num, ProcessStatus.PENDING, 0, 
                ...
                status_manager.update_status(
                    chain_id, stage_num, ProcessStatus.SUCCESS, 100,
                    completion_metadata, task_id=task_id
                )
                
                # 메트릭 로깅
                log_stage_metrics(chain_id, stage_num, stage_name, execution_time, input_size)
...
def create_stage_result(chain_id: str, stage: int, result_status: ProcessStatus, 
